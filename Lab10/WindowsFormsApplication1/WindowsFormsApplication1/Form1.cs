                    ...
                    else
                    {
                        ...
                        if (response)
                        {
                            ...
                            if (button == 1)
                            {
                                if (packetNumber%2 == 0)
                                {
                                    int temp = ((packet[2] << 16) | (packet[1] << 8) | (packet[0]));
                                    float temp2 = (float) temp / 10;
                                    updateText1("temperature: ");
                                    updateText1(temp2.ToString());
                                    updateText1("\n");
                                } else if (packetNumber%2 == 1)
                                {
                                    int temp = ((packet[0] << 16) | (packet[1] << 8) | (packet[2]));
                                    float temp2 = (float)temp / 100;
                                    updateText1("pressure: ");
                                    updateText1(temp2.ToString());
                                }
                            }
                            else if (button == 2)
